...
1단계 작업소 기반과 첫 RAG 검색 수직 슬라이스가 구현됐다. Markdown, TXT와 텍스트 PDF를 비동기로 파싱·색인하고 BM25 기준선과 E5 hybrid 검색, 원문 근거·하이라이트·뷰어, 저장 구성과 평가 비교를 제공한다. 격리 smoke는 foundation과 RAG fixture를 beat 없이 순서대로 완료한 뒤 beat 구성을 별도로 확인한다.
